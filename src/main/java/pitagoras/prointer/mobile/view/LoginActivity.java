...
import pitagoras.prointer.mobile.MainActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                Call<Usuario> call = AppLoader.getRetrofit().create(UsuarioAPI.class).getUsuarioByEmail(mEmail);
                Usuario usuario = call.execute().body();

                if (usuario != null) {

                    if (usuario.getUserName().equals(mEmail)) {
                        ...
                        if(usuario.getPassword().equals(mPassword)){
                            ...
                            editor.putString("UserId", usuario.getUserName());
                            editor.apply();

                             if(usuario.getTipoProfessor())startActivity(new Intent(LoginActivity.this, ProfessorActivity.class));
                            else startActivity(new Intent(LoginActivity.this, AlunoActivity.class));
